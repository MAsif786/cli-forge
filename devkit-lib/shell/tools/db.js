...
const tool = defineTool({
  manifest: { name: 'db', label: '🗄️  Database Client', hint: 'query PostgreSQL, SQLite, MySQL', keywords: ['database', 'sql', 'postgres', 'mysql', 'sqlite', 'query', 'mariadb', 'psql', 'table', 'schema'] },
  commands,
  execute,
});
